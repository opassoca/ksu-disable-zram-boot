...
## ⌨️ Alias de Acesso Rápido (Opcional)

Para verificar os logs do ZRAM no boot instantaneamente a partir de qualquer diretório no Termux, adicione este alias ao seu `~/.bashrc`:
